...
./build/ARM/gem5.opt -d baselinetestcheck configs/spec2k6/run.py -b bzip2 --maxinsts=1000000 --cpu-type=DerivO3CPU --caches --l1d_size=32kB  --l1d_assoc=2 --l1i_size=32kB --l1i_assoc=2  --l2cache --l2_size=2MB --l2_assoc=8 
