...
benchmarks=(bzip2 gamess h264ref gcc mcf hmmer)

for b in "${benchmarks[@]}"; do
    folder="baseline_"$b
    echo $b, $folder
    ./build/ARM/gem5.opt -d $folder configs/spec2k6/run.py -b $b --maxinsts=1000000000 --standard-switch=1000000000 --warmup-insts=50000000 --cpu-type=DerivO3CPU --caches --l2cache &
done 